...
<p><strong>Artifacts:</strong></p>
<p>— xUnit <code>[Theory]</code> / <code>[InlineData]</code> test output</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— SQL query results, Lambda CloudWatch log snippet</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— SQL GROUP BY query results</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— <code>aws s3 ls</code> output or S3 SDK list result</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— CloudWatch log snippet, row count before/after</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— Row <code>Id</code> and <code>CreatedAt</code> values, CloudWatch log</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— Row counts run 1 vs run 2, CloudWatch log for run 2</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— CloudWatch log, DB row count before/after, row <code>Id</code> values (new <code>Id</code> after re-creation)</p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— CloudWatch log, DB row showing <code>BaseClearingAccountNumber = ClearingAccountNumber</code></p>
<hr>
...
<p><strong>Artifacts:</strong></p>
<p>— DB query result showing exact 1 row</p>
<hr>
